...
mod tests {
    ...
    fn progression_good() {
        ...
        let out = algo.compute(&h, Rating::Good, NOW + 2 * DAY);
    ...
    fn again_returns_to_box_0() {
        ...
        let out = algo.compute(&h, Rating::Again, NOW + 5 * DAY);
    ...
    fn hard_descends_one_box() {
        ...
        let h = make_history(&[Rating::Good, Rating::Good, Rating::Good]);
        let out = algo.compute(&h, Rating::Hard, NOW + 5 * DAY);
    ...
    fn hard_at_box_0_stays_box_0() {
        let algo = Leitner;
        let out = algo.compute(&[], Rating::Hard, NOW);
    ...
    fn max_box_cap() {
        ...
        let out = algo.compute(&h, Rating::Good, NOW + 10 * DAY);
